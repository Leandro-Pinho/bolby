...
const HeaderSocials = () => {
    return (
        <div className="home__socials">
            <a href="https://www.instagram.com/" className="home__social-link" target='_blank' rel="noopener noreferrer">                <i className="fa-brands fa-instagram"></i>
            </a>
            ...
            <a href="https://br.pinterest.com/" className="home__social-link" target='_blank' rel="noopener noreferrer">
